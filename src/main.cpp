...
void cap_args(int& argc, char** argv){
    ...
    for (int i = 1; i<argc; i++){
        ...
        else if (arg == "--log0") ST::core::log::log_level = 0;
        else if (arg == "--log1") ST::core::log::log_level = 1;
        else if (arg == "--log2") ST::core::log::log_level = 2;
        else if (arg == "--log3") ST::core::log::log_level = 3;
        else if (arg == "--log4") ST::core::log::log_level = 4;
    }
}

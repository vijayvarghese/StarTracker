...
static constexpr auto READER_PERIOD =
    std::chrono::milliseconds(static_cast<int>(1000.0 / READER_HZ));

static constexpr double TRACKER_HZ = 1.0;
static constexpr auto PROCESSOR_PERIOD =
    std::chrono::milliseconds(static_cast<int>(1000.0 / TRACKER_HZ));

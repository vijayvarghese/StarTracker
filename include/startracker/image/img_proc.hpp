...
/**
 * @brief Process and find centroids with cv::connectedComponentsWithStats, max
 * area filtering with MaxArea global config.
 * @param BW Preprocessed cv::Mat frame reference, from which centroids are
 * found;
 * @param ts Reference to the tic counter (debug timestamping)
